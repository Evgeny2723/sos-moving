...
Webflow.push(function () {
	// ... (оставьте этот блок как есть, если не требуется дальнейшая детализация)
	// Здесь идут инициализации слайдеров, пагинации, разделителей, оглавления и т.д.
	// Для краткости не переписываю весь блок, но его можно аналогично отформатировать.
});
...
function openDropdown(dropdown) {
	...
	content.css({ height: content.find("div").innerHeight(), opacity: 1 });
